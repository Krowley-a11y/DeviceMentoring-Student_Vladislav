...
* Студент: [Имя Фамилия](Ссылка).
* Наставник: [Имя Фамилия](Ссылка).
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/632047-device-24) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
